                                ...
                                <div class="row">
                                        ...
                                        <div class="span8 page-content">
                                                ...
                                                <section id="comments">
                                                        ...
                                                        <h3 id="comments-title">(3) 回帖內容</h3>
                                                        ...
                                                        <div id="respond">
                                                                ...
                                                                <form action="ok.php" method="post" id="commentform">
                                                                        ...
                                                                        <div>
                                                                                ...
                                                                                <textarea class="span8" name="comment" id="comment" cols="58" rows="10" required="requried"></textarea>
                                                                        </div>
                                                                        <div>
                                                                                <button type="submit" class="btn btn-default" id="judge_reply" name="judge_reply">送出</button>
